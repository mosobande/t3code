...
export function createDesktopClerkBridge(stateDir: string, protocolScheme: string) {
...
export const make = Effect.gen(function* () {
  ...
  const bridge = yield* Effect.acquireRelease(
    Effect.try({
      try: () => createDesktopClerkBridge(environment.stateDir, environment.protocolScheme),
      catch: (cause) =>
