  ...
  it.effect("falls back to effect/config values when flags are omitted", () =>
    Effect.gen(function* () {
      ...
      expect(resolved).toEqual({
        ...
        baseDir,
        ...derivedPaths,
        host: productProfile.capabilities.networkExposure ? "0.0.0.0" : "127.0.0.1",
        staticDir: undefined,
  ...
  it.effect("uses CLI flags when provided", () =>
    Effect.gen(function* () {
      ...
      expect(resolved).toEqual({
        ...
        logWebSocketEvents: true,
        tailscaleServeEnabled: productProfile.capabilities.networkExposure,
  ...
  it.effect("uses bootstrap envelope values as fallbacks when flags and env are absent", () =>
    Effect.gen(function* () {
      ...
      expect(resolved).toEqual({
        ...
        baseDir,
        ...derivedPaths,
        host: productProfile.capabilities.networkExposure ? "127.0.0.2" : "127.0.0.1",
  ...
  it.effect("forces noBrowser and disables auto-bootstrap for headless startup presentation", () =>
    Effect.gen(function* () {
      ...
      expect(resolved).toEqual({
        ...
        baseDir,
        ...derivedPaths,
        host: productProfile.capabilities.networkExposure ? undefined : "127.0.0.1",
        staticDir: resolved.staticDir,
        devUrl: undefined,
        noBrowser: true,
        startupPresentation: "headless",
