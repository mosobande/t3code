  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new SIGIDI prerelease is available for nightly testers."
          : "A new SIGIDI latest release is available.",
...
).pipe(Command.withDescription("Post a SIGIDI release announcement to Discord."));
