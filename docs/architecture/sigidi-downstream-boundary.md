...
| ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ---------------------- |
| [Prompt clarification](../internals/prompt-clarification.md) | Shared text-generation API and five provider adapters; composer toolbar and overflow, right panel, settings, command, contract, and server host files listed in the feature record | `upstream/main@41ebf22e` | Add the SIGIDI-owned pre-send rewrite operation, independent model selection, and web/desktop entry-point registration without a generic extension framework | Prompt clarification maintainer | Required focused contract, provider, service, RPC, controller, composer, settings, and keybinding proof; required web and desktop integration proof listed in the feature record | Remove or narrow these edits when upstream exposes stable provider-neutral utility-generation and composer/settings command seams that preserve independent selection, strict availability, no-send behavior, explicit replacement, stale-result protection, and local-only panel state | None                 | 2026-08-05             |
