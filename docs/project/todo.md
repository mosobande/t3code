...
## SIGIDI service migration and cleanup
...
- [ ] Review the anonymous event fields and update externally visible T3 Code names
...
### Remove unused mobile services

- [ ] Remove or disable Expo and EAS build and release workflows
- [ ] Remove APNs credentials and relay configuration
- [ ] Remove mobile-specific Google OAuth configuration
- [ ] Remove remaining iOS application setup and documentation
